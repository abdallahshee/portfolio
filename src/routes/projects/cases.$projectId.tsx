import { CreateCaseFormSchema, type CreateCaseFormRequest } from '@/db/validations/case.types'
...
function RouteComponent() {
  ...
  const form = useForm<CreateCaseFormRequest>({
    initialValues: {
      problem: '',
      solution: '',
      implementation: '',
  ...
  const handleSubmit = async (values: CreateCaseFormRequest) => {
    try {
      setLoading(true)
