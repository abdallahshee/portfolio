    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-gray-800 dark:text-gray-200 text-xl font-semibold">Article not found</h2>
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden border border-gray-200 dark:border-slate-700">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-sm font-medium transition-all duration-150 ${likedByUser
                  ...
                  <button
                    ...
                    disabled={isLikePending || !likedByUser}
                    className={`px-3 py-2 transition-colors ${!likedByUser
          ...
          <div className="space-y-4">
            ...
            {data.categoryName && (
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 p-5 shadow-sm">
                <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-3">Category</p>
                <span className="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-300 text-sm rounded-full">
                  {data.categoryName}
                </span>
              </div>
            )}
