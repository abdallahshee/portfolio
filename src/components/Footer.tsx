          ...
          <Stack gap="md">
            <Link to="/" className="inline-block w-fit">
              <Image
                ...
                radius="md"
                fit="cover"
                className="ring-2 ring-indigo-100 transition-opacity duration-200 hover:opacity-80 dark:ring-indigo-900"
              />
            </Link>
            <Stack gap={4}>
          ...
          <Stack gap="sm">
            ...
            <Group gap="xs" wrap="nowrap" align="flex-start" className="min-w-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="min-w-0 break-words text-sm text-slate-600 transition-colors hover:text-indigo-500 dark:text-slate-400 dark:hover:text-indigo-400"
              >
                +254 796 515 302
              </a>
            </Group>
